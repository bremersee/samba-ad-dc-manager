...
public class DomainRepositoryImpl extends AbstractRepository implements DomainRepository {
  ...
  private final HostNameTool hostNameTool;

  private final DomainTool domainTool;
  ...
  public DomainRepositoryImpl(
      ...
      HostNameTool hostNameTool,
      DomainTool domainTool) {
    super(properties, ldapTemplate);
    this.random = new SecureRandom();
    this.hostNameTool = hostNameTool;
  ...
  public String getHostName() {
    if (isEmpty(hostName)) {
      hostName = Optional.ofNullable(getProperties().getHostName())
          ...
          .orElseGet(hostNameTool::getHostName);
    }
    return hostName;
  }

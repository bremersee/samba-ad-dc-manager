...
import org.bremersee.samba.ad.dc.repository.tools.cli.validator.DomainGroupAddValidator;
import org.bremersee.samba.ad.dc.repository.tools.cli.validator.DomainGroupDeleteValidator;
import org.bremersee.samba.ad.dc.repository.tools.cli.validator.DomainGroupMoveValidator;
import org.bremersee.samba.ad.dc.repository.tools.cli.validator.DomainGroupRenameValidator;
...
class DomainGroupToolExecutor extends SambaToolExecutor implements DomainGroupTool {
  ...
  public void addGroup(DomainGroup domainGroup, Dn ou, Boolean isRfc2307Enabled) {
    ...
    execute(commands, new DomainGroupAddValidator(domainGroup));
  }
  ...
  public DomainGroup renameAndMoveGroup(
    ...
    if (cnChanged || samAccountNameChanged || emailChanged) {
      ...
      execute(commands, new DomainGroupRenameValidator(oldDomainGroup, newDomainGroup));
    }
  ...
  public void deleteGroup(String samAccountName) {
    ...
    execute(commands, new DomainGroupDeleteValidator(samAccountName));
  }

...
import org.bremersee.samba.ad.dc.repository.cli.validator.UserDeleteValidator;
import org.bremersee.samba.ad.dc.repository.cli.validator.UserMoveValidator;
import org.bremersee.samba.ad.dc.repository.cli.validator.UserRenameValidator;
...
public class SambaToolUserCli extends SambaToolCli implements SambaToolUser {
  ...
  public void addUser(
    ...
    if (isEmpty(domainUser.getAccountExpires())) {
      ...
      execute(noExpiryCommands, response -> log.debug("{}", response.toOneLine()));
    }
  }

...
import org.bremersee.samba.ad.dc.repository.tools.cli.validator.DomainUserAddValidator;
import org.bremersee.samba.ad.dc.repository.tools.cli.validator.DomainUserDeleteValidator;
import org.bremersee.samba.ad.dc.repository.tools.cli.validator.DomainUserMoveValidator;
import org.bremersee.samba.ad.dc.repository.tools.cli.validator.DomainUserRenameValidator;
...
public class DomainUserToolExecutor extends SambaToolExecutor implements DomainUserTool {
  ...
  public void addUser(
    ...
    execute(commands, new DomainUserAddValidator(domainUser));
  }
  ...
  public DomainUser renameAndMoveUser(
    ...
    if (!oldCn.equals(newCn) || !oldSamAccountName.equals(newSamAccountName)) {
      ...
      execute(commands, new DomainUserRenameValidator(oldDomainUser, newDomainUser));
    }
  ...
  public void deleteUser(String samAccountName) {
    ...
    execute(commands, new DomainUserDeleteValidator(samAccountName));
  }

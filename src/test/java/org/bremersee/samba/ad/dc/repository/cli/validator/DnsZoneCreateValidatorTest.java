...
/**
 * The dns zone create validator test.
 *
 * @author Christian Bremer
 */
class DnsZoneCreateValidatorTest {

  private static final DnsZoneCreateValidator target = new DnsZoneCreateValidator("intranet");
  ...
  void getExpectedResponse() {
    assertThat(target.getExpectedResponse())
        .isEqualTo("Zone intranet created successfully");
  }
  ...
  void getErrorCode() {
    assertThat(target.getErrorCode())
        .isEqualTo(ErrorCode.EC_CREATING_DNS_ZONE_FAILED);
  }

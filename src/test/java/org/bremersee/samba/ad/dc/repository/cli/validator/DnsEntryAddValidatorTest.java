...
/**
 * The dns entry add validator test.
 *
 * @author Christian Bremer
 */
class DnsEntryAddValidatorTest {

  private static final DnsEntryAddValidator target = new DnsEntryAddValidator();
  ...
  void getErrorCode() {
    assertThat(target.getErrorCode())
        .isEqualTo(ErrorCode.EC_ADDING_DNS_ENTRY_FAILED);
  }

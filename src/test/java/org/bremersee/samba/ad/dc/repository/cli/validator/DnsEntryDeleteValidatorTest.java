...
/**
 * The dns entry delete validator test.
 *
 * @author Christian Bremer
 */
class DnsEntryDeleteValidatorTest {

  private static final DnsEntryDeleteValidator target = new DnsEntryDeleteValidator();
  ...
  void getErrorCode() {
    assertThat(target.getErrorCode())
        .isEqualTo(ErrorCode.EC_DELETING_DNS_ENTRY_FAILED);
  }

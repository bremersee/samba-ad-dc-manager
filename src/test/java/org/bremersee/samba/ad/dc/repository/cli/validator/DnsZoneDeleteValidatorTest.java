...
/**
 * The dns zone delete validator test.
 *
 * @author Christian Bremer
 */
class DnsZoneDeleteValidatorTest {

  private static final DnsZoneDeleteValidator target = new DnsZoneDeleteValidator("intranet");
  ...
  void getExpectedResponse() {
    assertThat(target.getExpectedResponse())
        .isEqualTo("Zone intranet deleted successfully");
  }
  ...
  void getErrorCode() {
    assertThat(target.getErrorCode())
        .isEqualTo(ErrorCode.EC_DELETING_DNS_ZONE_FAILED);
  }
  ...
  void validate(String value) {
    ...
    CommandExecutorResponse response = new CommandExecutorResponse(stdout, "bad input");
